...
function activate(context) {
    ...
    const completionProvider = vscode.languages.registerCompletionItemProvider(['dact-tool', 'dact-scenario', 'dact-case'], {
        provideCompletionItems(document, position) {
            ...
            if (document.languageId === 'dact-tool') {
                completionItems.push(new vscode.CompletionItem('name', vscode.CompletionItemKind.Property), new vscode.CompletionItem('description', vscode.CompletionItemKind.Property), new vscode.CompletionItem('type', vscode.CompletionItemKind.Property), new vscode.CompletionItem('command_template', vscode.CompletionItemKind.Property), new vscode.CompletionItem('parameters', vscode.CompletionItemKind.Property), new vscode.CompletionItem('post_exec', vscode.CompletionItemKind.Property), new vscode.CompletionItem('success_pattern', vscode.CompletionItemKind.Property), new vscode.CompletionItem('failure_pattern', vscode.CompletionItemKind.Property));
            }
            else if (document.languageId === 'dact-scenario') {
                completionItems.push(new vscode.CompletionItem('name', vscode.CompletionItemKind.Property), new vscode.CompletionItem('description', vscode.CompletionItemKind.Property), new vscode.CompletionItem('steps', vscode.CompletionItemKind.Property), new vscode.CompletionItem('default_params', vscode.CompletionItemKind.Property), new vscode.CompletionItem('environment', vscode.CompletionItemKind.Property));
            }
            else if (document.languageId === 'dact-case') {
                completionItems.push(new vscode.CompletionItem('cases', vscode.CompletionItemKind.Property), new vscode.CompletionItem('common_params', vscode.CompletionItemKind.Property));
            }
            // Add Jinja2 template completions
            if (linePrefix.includes('{{')) {
                completionItems.push(new vscode.CompletionItem('steps.', vscode.CompletionItemKind.Variable), new vscode.CompletionItem('case.', vscode.CompletionItemKind.Variable), new vscode.CompletionItem('outputs.', vscode.CompletionItemKind.Variable));
            }
